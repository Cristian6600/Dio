...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='guia',
            fields=[
                ('paquete_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='fisico.paquete')),
                ('g', models.AutoField(primary_key=True, serialize=False, unique=True, verbose_name='Guia')),
